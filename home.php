...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1><?php echo "Welcome to Scoops & Dreams!"?></h1>
      <h2><?php echo "Where Every Bite Takes You To Ice Cream Paradise"?></h2>
      <a href="about.php" class="btn-get-started"><?php echo "Get Started"?></a>
    </div>
  </section><!-- End Hero -->
