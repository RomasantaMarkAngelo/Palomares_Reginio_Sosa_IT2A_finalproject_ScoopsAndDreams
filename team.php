...
$img1 = "assets/img/team/cha.jpg";
$img2 = "assets/img/team/carms.jpg";
$img3 = "assets/img/team/eca.jpg";
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2><?php echo "Team"?></h2>
          <p><?php echo "Tough times don't last, tough teams do."?></p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img">
                <img src="assets/img/team/cha.jpg" class="img-fluid" alt="">
                <div class="social">
              ...
              <div class="member-info">
                <h4><?php echo "Charlene Z. Reginio"?></h4>
                <span><?php echo "Chief Executive Officer"?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img">
                <img src="assets/img/team/carms.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
              ...
              <div class="member-info">
                <h4><?php echo "Carmelyn A. Palomares"?></h4>
                <span><?php echo "Product Manager"?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <div class="member-img">
                <img src="assets/img/team/eca.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
